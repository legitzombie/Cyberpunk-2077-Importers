...
for %%i in ("%script_path%\..") do set "temp_path=%%~fi\temp\archive\base\movies\fullscreen\e3_2020_loading\"

"%cli_path%" pack -p "%archive_path%" -o "%perm_path%"

rename "%perm_path%\archive.archive" "CustomSplashScreen.archive"
