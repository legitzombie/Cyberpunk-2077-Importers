...
output_folder = safe_path(parent_folder / "temp" / Path(r"archive\base\environment\decoration\advertising\holograms\giant_commercial_stripe") )
atlas_name = "giant_commercial_stripe_b_censored"
